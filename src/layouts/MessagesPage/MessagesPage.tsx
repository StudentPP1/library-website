...
import {PostMessage} from "./components/PostMessage.tsx";
        ...
        <div className='container'>
            <div className='mt-3 mb-2'>
                <nav>
                    ...
                    >
                        <button
                            onClick={() => setMessagesClick(false)} className='nav-link active'
                        ...
                        <button
                            onClick={() => setMessagesClick(true)} className='nav-link'
                            id='nav-message-tab'
                            data-bs-toggle='tab'
